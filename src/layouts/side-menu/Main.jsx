...
function Main() {
  ...
  const sideMenuforUser = () =>
    nestedMenu($h.toRaw(sideMenuStoreUser.menuforUser), location);
  const sideMenuforAdmin = () =>
    nestedMenu($h.toRaw(sideMenuStoreAdmin.menuforAdmin), location);
      ...
      <div className="flex mt-[4.7rem] md:mt-0">
        ...
        <nav className="side-nav">
          <div className="intro-x flex items-center pl-5 pt-4">
            <img alt="Customer Portal" className="w-45" src={logoUrl}/>
