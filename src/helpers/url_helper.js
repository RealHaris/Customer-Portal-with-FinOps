...
import { VERIFY_EMAIL_SUCCESS } from "./../store/login/actionTypes";
...
export const GET_ORDER_DETAILS = "/order-management/specific";
...
//PRODUCT LIST
export const GET_PRODUCT_LIST = "/products/getAll";
...
export const VERIFY_EMAIL = "/auth/forgotPassword";
...
export const GET_CREDIT_CARD_INFO = "/user/viewCreditCardsInfo";
export const GET_BANK_ACCOUNT_INFO = "/user/viewBankAccountInfo";
export const CREATE_PAYMENT_JOURNAL = "/invoice/createPaymentJournal";

export const ADD_BANK_ACCOUNT = "/user/createBankAccountInfo";
export const ADD_CREDIT_CARD = "/user/createCreditCardInfo";
export const GET_AVAILABLE_CARDS = "/user/viewAllAvailableCards";
