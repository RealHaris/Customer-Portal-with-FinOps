...
function Main() {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object().shape({
      shipping_date: Yup.string()
        ...
        .test(
          "is-after-today",
          "Shipping Date cannot be after today's date",
          (value) => {
            if (value) {
  ...
  const onSelectChangeHandle = (rec, index) => {
    ...
    validation.setFieldValue(
      `sales_order_lines.${index}.SalesUnit`,
      rec.ItemUnit
    );
    ...
    validation.setFieldValue(
      `sales_order_lines.${index}.ItemTaxGroup`,
      rec.ItemTaxGroup
    );
                    ...
                    <div className="w-full mt-3 xl:mt-0 flex-1">
                      ...
                      {submission && validation.errors.shipping_date && (
                        <div className="text-red-400 mt-2">
                          {validation.errors.shipping_date}
                        </div>
                      )}
                    </div>
                  </div>
                          ...
                          <Select
                            ...
                            value={
                              orderTypeOptions.find(
                                (obj) =>
                                  obj.value === validation.values.order_type
                              ) || ""
                            }
                            onChange={(e) => {
                          ...
                          <table className="table">
                            <thead>
                              <tr>
                                ...
                                {validation.values.sales_order_lines.length !=
                                1 ? (
                            ...
                            <tbody>
                              {validation.values?.sales_order_lines.map(
                                (rec, index) => {
                                  return (
                                    <tr key={index}>
                                      ...
                                      />*/}
                                        ...
                                        {submission &&
                                        validation.errors.hasOwnProperty(
                                          "sales_order_lines"
                                        ) &&
                                      ...
                                      <td className="!pl-4 text-slate-500">
                                        {validation.values.sales_order_lines
                                          .length != 1 ? (
                                          <button
                                            type="button"
                                            onClick={() => {
